// com/managerlibrary/daos/implement/LoanDAOImpl.java
...
public class LoanDAOImpl implements LoanDAO {
    ...
    public Loan getLoanById(int id) throws SQLException {
        String sql = "SELECT l.id AS loan_id, l.book_id, l.user_id, l.loan_date, l.return_date, l.actual_return_date, l.status, l.fine, " +
                ...
                "u.name AS user_name, u.cpf AS user_cpf, b.id AS b_id, u.id AS u_id " + // Adicionado b.id e u.id para criar os objetos
                "FROM loan l " +
        ...
        try (Connection conn = DataBaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                Book book = new Book();
                book.setId(rs.getInt("b_id")); // Usando o alias b_id
                book.setTitle(rs.getString("book_title"));
                book.setAuthor(rs.getString("book_author"));
                loan.setBook(book);

                User user = new User();
                user.setId(rs.getInt("u_id")); // Usando o alias u_id
    ...
    public List<Loan> getAllLoansWithDetails() throws SQLException {
        ...
        String sql = "SELECT l.id AS loan_id, l.book_id, l.user_id, l.loan_date, l.return_date, l.actual_return_date, l.status, l.fine, " +
                "b.title AS book_title, b.author AS book_author, " +
                "u.name AS user_name, u.cpf AS user_cpf, b.id AS b_id, u.id AS u_id " + // Adicionado b.id e u.id
                "FROM loan l " +
                "JOIN books b ON l.book_id = b.id " +
                "JOIN \"users\" u ON l.user_id = u.id";
        try (Connection conn = DataBaseConnection.getConnection();
